//! SHA-256, SHA-384 et SHA-512 (FIPS 180-4), requis par les révisions 5 et 6
//! du gestionnaire de sécurité standard (ISO 32000-2 §7.6.4.3.3 et §7.6.4.3.4).
